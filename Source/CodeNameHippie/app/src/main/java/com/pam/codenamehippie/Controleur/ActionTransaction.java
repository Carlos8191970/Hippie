...
public class ActionTransaction {
     ...
     * @param donneur instance de organisme donneur
     * @param marchandise instance de marchandise
     *
     * @return objet transaction avec les informations à envoyer par une requête SQL
     */
    public TransactionModele ajouterMarchandise(TransactionModele transaction, OrganismeModele donneur,
    ...
    public TransactionModele modifierMarchandise(){
        //TODO: Réflexion sur comment modifier une transaction sur marchandise. Ex: modifier quantité en cas d'erreur.
        return null;
    }

    /**
     * Méthode pour réserver une marchandise en modifiant une transaction existante. La date du jour
     * sera considérée comme date de réservation lors de la requête au serveur.
     *
     * @param transaction objet transaction à modifier
     * @param receveur organisme receveur à insérer dans la transaction
     *
     * @return transaction avec les informations à envoyer par une requête SQL
     */
    public TransactionModele reserverMarchandise(TransactionModele transaction, OrganismeModele receveur) {
     ...
     *
     * @param transaction objet transaction à canceller
     *
     ...
     *
     * @param transaction objet transaction à collecter
     *
     * @return transaction à envoyer par une requête SQL
     */
